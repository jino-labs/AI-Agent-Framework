...
const cases = [
  ...
  ['safe build command', { tool_name: 'Bash', tool_input: { command: 'dotnet build' } }, false],
  ['safe write in repo', { tool_name: 'Write', tool_input: { file_path: path.join(ROOT, 'src/Foo.cs') } }, false],
